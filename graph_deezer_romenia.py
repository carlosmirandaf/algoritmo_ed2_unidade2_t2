#Para o Deezer, os nós vão representar os usuários e as arestas as amizades
#em comum. Os dados usados usam a Romênia como exemplo
...
with open('RO_edges.csv', 'r') as file:
    next(file)
