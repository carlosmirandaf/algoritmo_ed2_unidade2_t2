...
# Crie um objeto de grafo bipartido
G = nx.Graph()
fig, ax = plt.subplots(figsize=(9,9))

# Crie dois conjuntos de nós
nodes_left = set()
nodes_right = set()

# Leia o arquivo de texto e adicione nós aos conjuntos correspondentes
...
# Leia o arquivo novamente para adicionar as arestas
with open('facebook_combined.txt', 'r') as file:
    for line in file:
        node1, node2 = map(int, line.strip().split())
